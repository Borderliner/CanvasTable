...
export default class Scroller {
  ...
  domInit() {
    return (
      <div className={'x-canvas-scroll'} style={{ width: `${this.props.width}px`, height: `${this.props.height}px` }}>
        <div ref={this.shadowLeftRef} className={'x-scroll-shadow-left'} />
        <div ref={this.shadowRightRef} className={'x-scroll-shadow-right'} style={{ right: `${SCROLLBAR_WIDTH}px` }} />
        <div
        ...
        >
          <div ref={this.scrollEndRef} className={'x-canvas-scroll-end'} />
          {this.props.children}
        </div>
      </div>
    )
